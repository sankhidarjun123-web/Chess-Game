...
const checkForChecks = require('../KingMovementHandler/Check.js');

function checkKingMoves(row, col, initialBoard, demandMoves, castleStatus) {
    let moves = [], captures = [];
...
function checkSquare(piece, r, c, initialBoard) {
